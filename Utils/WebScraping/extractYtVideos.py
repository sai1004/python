...
def get_comments(url):
    ...
    while continuation_tokens:
        ...
        response = session.post(
            "https://www.youtube.com/comment_service_ajax", params=params, data=data, headers=headers)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Simple YouTube Comment extractor")
    parser.add_argument("url", help="The YouTube video full URL")
    parser.add_argument("-l", "--limit", type=int,
                        help="Number of maximum comments to extract, helpful for longer videos")
    parser.add_argument(
        "-o", "--output", help="Output JSON file, e.g data.json")
...
How To Use :
 ...
 python .\extractYtVideos.py https://www.youtube.com/watch?v=jNQXAC9IVRw --limit 5 --output comments50.json

 python .\extractYtVideos.py https://www.youtube.com/watch?v=jNQXAC9IVRw --limit 5  
